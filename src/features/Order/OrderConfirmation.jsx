...
const OrderConfirmation = () => {
  ...
  return (
    <div className="min-h-screen bg-white m-4">
      <div className="flex items-center justify-center px-4 py-2 border-b p-4">
        <div className="w-full max-w-md text-center">
          ...
          <div className="text-gray-400 font-light text-xs">
            18, Jl. H. R. Rasuna Said No.18, RT.18/RW.2, Kuningan, Karet
            Kuningan, Setiabudi, South Jakarta City, Jakarta 12920
          </div>
        </div>
      </div>
        ...
        <div className="p-4 border-gray-200 ">
          <div className="border-b pb-3 mb-2">
            <div className="flex justify-between items-center">
              ...
              <div className="text-center flex-1">
                <span className="block text-black-500 font-bold">
                  Queue Number
                </span>
                <span className="block text-black font-bold text-2xl">
      ...
      <div className=" text-black-500 font-bold">Pay at Cashier</div>
      <div className="text-center">
        <img
          src="https://i.pinimg.com/564x/aa/33/05/aa33051122786760db5479d9a10b1611.jpg"
          alt="Cashier"
